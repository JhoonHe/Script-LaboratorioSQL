...
exec sp_help profesor; -- Muestra la información de la tabla, nos interesa saber el nombre de la pk para quitarle la restricción 

alter table profesor drop constraint PK__profesor__08241E30A60EB501; -- Se altera la restricción de la pk
alter table profesor alter column doc_prof varchar(15) not null; -- Se altera la columna indicando que no se permitan nulos 
alter table profesor add constraint PK_profesor primary key (doc_prof); -- Se asigna la restricción a la pk dándole un nombre
...
exec sp_help estudiante; -- Muestra la información de la tabla, nos interesa saber el nombre de la pk para quitarle la restricción 
...
alter table estudiantexcurso drop constraint FK__estudiant__doc_e__4F7CD00D; -- Se elimina la restricción de la fk de la tabla estudiante 
alter table estudiante drop constraint PK__estudian__75DA98B06BA17741; -- Se altera la restricción de la pk
...
alter table estudiante add constraint PK_estudiante primary key (doc_est); -- Se asigna la restricción a la pk dándole un nombre
alter table estudiantexcurso add constraint FK_estudiante_doc foreign key (doc_est_estcur) references estudiante (doc_est) -- Se crea la restricción de la foránea
...
insert into articulo values ('Creación de un portal con php y mysql', 'Jacob Pavón Puertas', 'Alfaomega - Rama', 40000);
insert into articulo values ('Administración de sistemas operativos', 'Julio Gómez López', 'Alfaomega - Rama', 55000);
...
insert into compania values ('800890890-2', 'Seguros Atlantida', 1998, 'Carlos López');
insert into compania values ('899999999-1', 'Aseguradora Rojas', 1991, 'Luis Fernando Rojas');
insert into compania values ('899999999-5', 'Seguros del Estado', 2001, 'María Margarita Pérez');
...
insert into incidentes values ('2012-09-27', 'Girón', 1, 0, 1, 'FLL420');
...
exec sp_insertar_compania '899999999-7', 'Seguros del Pueblo', 2000, 'Ana Sofía';
...
insert into profesor values ('1004827001', 'Manuel', 'López', 1, 600000);
insert into profesor values ('1004827002', 'María', 'García', 2, 720000);
insert into profesor values ('1004827003', 'Jorge', 'Fernández', 3, 950000);
insert into profesor values ('1004827004', 'Luz', 'Martínez', 1, 580000);
insert into profesor values ('1004827005', 'Diego', 'Ramírez', 2, 710000);
insert into profesor values ('1004827006', 'Sandra', 'Pérez', 3, 920000);
insert into profesor values ('1004827007', 'Luisa', 'Sánchez', 1, 570000);
insert into profesor values ('1004827008', 'Andrés', 'Hernández', 2, 700000);
insert into profesor values ('1004827009', 'Elena', 'Gómez', 3, 980000);
insert into profesor values ('1004827010', 'Alejandro', 'Díaz', 1, 550000);
insert into profesor values ('1004827011', 'Carolina', 'Suárez', 2, 730000);
insert into profesor values ('1004827012', 'Gabriel', 'Torres', 3, 970000);
insert into profesor values ('1004827013', 'Ana', 'Jiménez', 1, 540000);
insert into profesor values ('1004827014', 'Mauricio', 'Ortega', 2, 690000);
insert into profesor values ('1004827015', 'Isabella', 'Londoño', 3, 940000);
...
insert into profesor values ('1004827018', 'Lucía', 'Molina', 3, 970000);
...
insert into profesor values ('1004827022', 'Lorena', 'Pérez', 1, 560000);
insert into profesor values ('1004827023', 'Andrea', 'Martínez', 2, 710000);
insert into profesor values ('1004827024', 'Roberto', 'Gómez', 3, 950000);
insert into profesor values ('1004827025', 'Laura', 'González', 1, 600000);
insert into profesor values ('1004827026', 'Manuel', 'López', 1, 600000);
insert into profesor values ('1004827027', 'María', 'García', 2, 720000);
insert into profesor values ('1004827028', 'Jorge', 'Fernández', 3, 950000);
insert into profesor values ('1004827029', 'Luz', 'Martínez', 1, 580000);
insert into profesor values ('1004827030', 'Diego', 'Ramírez', 2, 710000);
insert into profesor values ('1004827031', 'Sandra', 'Pérez', 3, 920000);
insert into profesor values ('1004827032', 'Luisa', 'Sánchez', 1, 570000);
insert into profesor values ('1004827033', 'Andrés', 'Hernández', 2, 700000);
insert into profesor values ('1004827034', 'Elena', 'Gómez', 3, 980000);
insert into profesor values ('1004827035', 'Alejandro', 'Díaz', 1, 550000);
insert into profesor values ('1004827036', 'Carolina', 'Suárez', 2, 730000);
insert into profesor values ('1004827037', 'Gabriel', 'Torres', 3, 970000);
insert into profesor values ('1004827038', 'Ana', 'Jiménez', 1, 540000);
insert into profesor values ('1004827039', 'Mauricio', 'Ortega', 2, 690000);
insert into profesor values ('1004827040', 'Isabella', 'Londoño', 3, 940000);
...
insert into profesor values ('1004827043', 'Lucía', 'Molina', 3, 970000);
...
insert into profesor values ('1004827046', 'Lorena', 'Gómez', 3, 960000);
insert into profesor values ('1004827047', 'Andrea', 'Herrera', 1, 550000);
insert into profesor values ('1004827048', 'Roberto', 'Suárez', 2, 710000);
...
insert into curso values ('Introducción a Java', 30, 600000);
insert into curso values ('Fundamentos de Python', 25, 550000);
insert into curso values ('Programación en C#', 40, 700000);
insert into curso values ('Desarrollo Web con HTML y CSS', 35, 650000);
insert into curso values ('JavaScript Avanzado', 50, 850000);
insert into curso values ('Diseño de Interfaces de Usuario', 30, 600000);
insert into curso values ('Programación en Ruby', 35, 700000);
insert into curso values ('Desarrollo de Aplicaciones Móviles', 45, 900000);
...
insert into curso values ('Programación en Dart', 30, 650000);
insert into curso values ('Introducción a la Inteligencia Artificial', 45, 850000);
insert into curso values ('Programación en Scala', 40, 750000);
insert into curso values ('Desarrollo de Aplicaciones de Internet de las Cosas (IoT)', 35, 700000);
insert into curso values ('Programación en Rust', 40, 800000);
insert into curso values ('Desarrollo de Aplicaciones de Machine Learning', 50, 1000000);
insert into curso values ('Introducción a la Ciberseguridad', 30, 600000);
insert into curso values ('Programación en Elixir', 40, 750000);
insert into curso values ('Desarrollo de Aplicaciones de Realidad Mixta', 60, 1200000);
insert into curso values ('Programación en Lua', 30, 600000);
insert into curso values ('Desarrollo de Aplicaciones de Automatización', 35, 700000);
insert into curso values ('Introducción a la Ciencia de Datos', 45, 900000);
insert into curso values ('Programación en Erlang', 40, 800000);
insert into curso values ('Desarrollo de Aplicaciones de Robótica', 55, 950000);

/* Estudiante */

insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827001', 'Camila', 'Gómez', 20);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827002', 'Santiago', 'Rodríguez', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827003', 'Valentina', 'Hernández', 21);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827004', 'Mateo', 'Fernández', 23);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827005', 'Luciana', 'Martínez', 20);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827006', 'Juan', 'Pérez', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827007', 'Sofía', 'Gutiérrez', 23);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827008', 'Dylan', 'Sánchez', 21);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827009', 'Mariana', 'López', 24);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827010', 'Matías', 'García', 20);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827011', 'Isabella', 'Ramírez', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827012', 'Diego', 'Díaz', 21);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827013', 'Valentín', 'González', 23);
...
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827017', 'Joaquín', 'Londoño', 21);
...
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827020', 'Andrés', 'Vargas', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827021', 'Sara', 'Gómez', 21);
...
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827026', 'Sebastián', 'Moreno', 21);
...
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827029', 'Mariano', 'Gálvez', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827030', 'Valentino', 'Silva', 21);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827031', 'Lucía', 'Girón', 23);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827032', 'Emiliano', 'Suárez', 20);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827033', 'Danna', 'Linares', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827034', 'Matías', 'Jaramillo', 21);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827035', 'Valentina', 'León', 23);
...
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827040', 'Juan Diego', 'Mejía', 20);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827041', 'Mía', 'Zuluaga', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827042', 'Joaquín', 'Santos', 21);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827043', 'Sofía', 'Castillo', 23);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827044', 'Lucas', 'Rincón', 20);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827045', 'Valentina', 'Paredes', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827046', 'Simón', 'Sánchez', 20);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827047', 'Valeria', 'Herrera', 22);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827048', 'Luciano', 'Gómez', 21);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827049', 'Sofía', 'Fernández', 23);
insert into estudiante (doc_est, nom_est, ape_est, edad_est) values ('1004827050', 'Diego', 'Martínez', 20);
...
insert into cliente values ('1004827001', 'Camila', 'Gómez', 'Carrera 34 No.14-45', 'Bogotá', 'Abril');
insert into cliente values ('1004827002', 'Santiago', 'Rodríguez', 'Calle 30 No.13-45', 'Medellín', 'Junio');
insert into cliente values ('1004827003', 'Valentina', 'Hernández', 'Diagonal 23 No. 12-34 apto 101', 'Cali', 'Marzo');
insert into cliente values ('1004827004', 'Mateo', 'Fernández', 'Avenida El Libertador No.30-14', 'Bucaramanga', 'Marzo');
insert into cliente values ('1004827005', 'Luciana', 'Martínez', 'Carrera 28 No.8-56', 'Barranquilla', 'Mayo');
insert into cliente values ('1004827006', 'Juan', 'Pérez', 'Calle 12 No.45-23 apto 202', 'Cúcuta', 'Agosto');
insert into cliente values ('1004827007', 'Sofía', 'Gutiérrez', 'Avenida 5 No.18-30', 'Cartagena', 'Diciembre');
insert into cliente values ('1004827008', 'Dylan', 'Sánchez', 'Calle 10 No.3-25', 'Pereira', 'Julio');
insert into cliente values ('1004827009', 'Mariana', 'López', 'Carrera 15 No.24-15', 'Manizales', 'Febrero');
insert into cliente values ('1004827010', 'Matías', 'García', 'Calle 9 No.17-40', 'Armenia', 'Noviembre');
insert into cliente values ('1004827011', 'Isabella', 'Ramírez', 'Carrera 7 No.11-5', 'Santa Marta', 'Abril');
insert into cliente values ('1004827012', 'Diego', 'Díaz', 'Diagonal 8 No.6-10', 'Barranquilla', 'Junio');
insert into cliente values ('1004827013', 'Valentín', 'González', 'Calle 5 No.9-20', 'Bogotá', 'Agosto');
insert into cliente values ('1004827014', 'Luna', 'Torres', 'Avenida 6 No.12-15', 'Medellín', 'Diciembre');
...
insert into cliente values ('1004827017', 'Joaquín', 'Londoño', 'Diagonal 10 No.5-18', 'Barranquilla', 'Abril');
insert into cliente values ('1004827018', 'Camilo', 'Montoya', 'Carrera 12 No.22-12 apto 301', 'Cúcuta', 'Marzo');
insert into cliente values ('1004827019', 'Ana', 'Arroyo', 'Calle 15 No.14-8', 'Cartagena', 'Mayo');
insert into cliente values ('1004827020', 'Andrés', 'Vargas', 'Avenida 8 No.13-5', 'Pereira', 'Junio');
insert into cliente values ('1004827021', 'Sara', 'Gómez', 'Carrera 14 No.7-15', 'Manizales', 'Noviembre');
...
insert into cliente values ('1004827024', 'Luis', 'Arias', 'Avenida 3 No.5-10', 'Bogotá', 'Mayo');
insert into cliente values ('1004827025', 'Renata', 'Rojas', 'Calle 11 No.10-22', 'Medellín', 'Julio');
insert into cliente values ('1004827026', 'Sebastián', 'Moreno', 'Carrera 25 No.12-45', 'Cali', 'Febrero');
...
insert into cliente values ('1004827029', 'Mariano', 'Gálvez', 'Calle 22 No.9-15', 'Cúcuta', 'Agosto');
insert into cliente values ('1004827030', 'Valentino', 'Silva', 'Carrera 7 No.5-10', 'Pereira', 'Mayo');
insert into cliente values ('1004827031', 'Lucía', 'Girón', 'Diagonal 12 No.14-22', 'Cartagena', 'Julio');
insert into cliente values ('1004827032', 'Emiliano', 'Suárez', 'Avenida 9 No.20-30', 'Manizales', 'Febrero');
insert into cliente values ('1004827033', 'Danna', 'Linares', 'Calle 8 No.11-18', 'Armenia', 'Abril');
insert into cliente values ('1004827034', 'Matías', 'Jaramillo', 'Carrera 10 No.15-25', 'Santa Marta', 'Noviembre');
insert into cliente values ('1004827035', 'Valentina', 'León', 'Diagonal 5 No.18-22', 'Bogotá', 'Marzo');
insert into cliente values ('1004827036', 'Max', 'Villamizar', 'Calle 15 No.11-5', 'Medellín', 'Abril');
...
insert into cliente values ('1004827040', 'Juan Diego', 'Mejía', 'Calle 30 No.20-15', 'Cúcuta', 'Febrero');
insert into cliente values ('1004827041', 'Mía', 'Zuluaga', 'Carrera 14 No.8-40', 'Cartagena', 'Junio');
insert into cliente values ('1004827042', 'Joaquín', 'Santos', 'Calle 22 No.16-25', 'Pereira', 'Agosto');
insert into cliente values ('1004827043', 'Sofía', 'Castillo', 'Avenida 8 No.7-30', 'Manizales', 'Julio');
insert into cliente values ('1004827044', 'Lucas', 'Rincón', 'Diagonal 5 No.10-22', 'Armenia', 'Diciembre');
insert into cliente values ('1004827045', 'Valentina', 'Paredes', 'Carrera 18 No.22-15', 'Santa Marta', 'Febrero');
insert into cliente values ('1004827046', 'Simón', 'Sánchez', 'Calle 11 No.14-30', 'Bogotá', 'Abril');
insert into cliente values ('1004827047', 'Valeria', 'Herrera', 'Calle 14 No.20-5', 'Medellín', 'Mayo');
insert into cliente values ('1004827048', 'Luciano', 'Gómez', 'Diagonal 3 No.11-18', 'Cali', 'Marzo');
insert into cliente values ('1004827049', 'Sofía', 'Fernández', 'Avenida 12 No.5-10', 'Bucaramanga', 'Junio');
insert into cliente values ('1004827050', 'Diego', 'Martínez', 'Carrera 10 No.16-22', 'Barranquilla', 'Julio');

/* Articulo */

insert into articulo values ('Aprende a usar las redes', 'Ana María Gómez', 'Editorial Colombia', 45000);
insert into articulo values ('Aprende a crear contenido', 'Juan Carlos López', 'Editorial Nacional', 55000);
insert into articulo values ('Programación en Python', 'Luisa Martínez', 'Editorial Andina', 65000);
insert into articulo values ('Introducción a la Inteligencia Artificial', 'Santiago Torres', 'Editorial Pacífico', 70000);
insert into articulo values ('Diseño de Interfaces de Usuario', 'María Rodríguez', 'Editorial Occidente', 48000);
insert into articulo values ('Aprende a programar en C#', 'Carlos Pérez', 'Editorial Colombiana', 62000);
insert into articulo values ('Desarrollo Web con HTML y CSS', 'Valentina Hernández', 'Editorial Cali', 57000);
insert into articulo values ('Fundamentos de SQL', 'Diego Gómez', 'Editorial Medellín', 50000);
insert into articulo values ('Desarrollo de Aplicaciones Móviles', 'Mariano Ramírez', 'Editorial Bogotá', 73000);
insert into articulo values ('Introducción a la Programación en R', 'Isabella Rodríguez', 'Editorial Barranquilla', 49000);
insert into articulo values ('Desarrollo de Aplicaciones de iOS', 'Luciano Martínez', 'Editorial Cartagena', 80000);
insert into articulo values ('Programación en Kotlin', 'Camila Gómez', 'Editorial Pereira', 64000);
insert into articulo values ('Desarrollo de Aplicaciones de Windows', 'Juan Pablo Herrera', 'Editorial Cúcuta', 75000);
insert into articulo values ('Programación en JavaScript', 'Andrés Vargas', 'Editorial Armenia', 58000);
insert into articulo values ('Desarrollo de Aplicaciones de Linux', 'Sara Gómez', 'Editorial Santa Marta', 67000);
insert into articulo values ('Diseño de Experiencia de Usuario (UX)', 'Diego Gómez', 'Editorial Bogotá', 50000);
insert into articulo values ('Programación en Go', 'Valentina Hernández', 'Editorial Cali', 70000);
insert into articulo values ('Desarrollo de Aplicaciones de macOS', 'Luciana Martínez', 'Editorial Medellín', 68000);
insert into articulo values ('Introducción a Ruby on Rails', 'Diego Gómez', 'Editorial Bogotá', 50000);
insert into articulo values ('Desarrollo de Aplicaciones de Realidad Virtual', 'Lucas Soto', 'Editorial Cúcuta', 90000);
insert into articulo values ('Programación en PHP', 'Danna Linares', 'Editorial Santa Marta', 62000);
insert into articulo values ('Desarrollo de Aplicaciones de Realidad Aumentada', 'Valentín González', 'Editorial Pereira', 86000);
insert into articulo values ('Programación en Perl', 'Mariana López', 'Editorial Armenia', 55000);
insert into articulo values ('Desarrollo de Chatbots', 'Matías Jaramillo', 'Editorial Barranquilla', 73000);
insert into articulo values ('Desarrollo de Aplicaciones de Blockchain', 'Ana Arroyo', 'Editorial Cartagena', 94000);
insert into articulo values ('Programación en Dart', 'Santiago Torres', 'Editorial Pacífico', 65000);
insert into articulo values ('Introducción a la Inteligencia Artificial', 'Camila Gómez', 'Editorial Colombia', 70000);
insert into articulo values ('Programación en Scala', 'Carlos Pérez', 'Editorial Nacional', 75000);
insert into articulo values ('Desarrollo de Aplicaciones de Internet de las Cosas (IoT)', 'Valentina Hernández', 'Editorial Andina', 88000);
insert into articulo values ('Programación en Rust', 'Diego Gómez', 'Editorial Bogotá', 65000);
insert into articulo values ('Desarrollo de Aplicaciones de Machine Learning', 'Luciano Martínez', 'Editorial Medellín', 92000);
insert into articulo values ('Introducción a la Ciberseguridad', 'Santiago Torres', 'Editorial Pacífico', 70000);
insert into articulo values ('Programación en Elixir', 'Mariano Ramírez', 'Editorial Bogotá', 74000);
insert into articulo values ('Desarrollo de Aplicaciones de Realidad Mixta', 'Ana Arroyo', 'Editorial Cartagena', 86000);
insert into articulo values ('Programación en Lua', 'Juan Carlos López', 'Editorial Nacional', 57000);
insert into articulo values ('Desarrollo de Aplicaciones de Automatización', 'Diego Gómez', 'Editorial Bogotá', 65000);
insert into articulo values ('Introducción a la Ciencia de Datos', 'Luciana Martínez', 'Editorial Medellín', 80000);
insert into articulo values ('Programación en Erlang', 'Sara Gómez', 'Editorial Santa Marta', 75000);
insert into articulo values ('Desarrollo de Aplicaciones de Robótica', 'Lucas Soto', 'Editorial Cúcuta', 90000);
insert into articulo values ('Seguridad en Redes', 'Danna Linares', 'Editorial Santa Marta', 62000);
insert into articulo values ('Desarrollo de Sistemas Embebidos', 'Valentín González', 'Editorial Pereira', 84000);
insert into articulo values ('Programación en Swift', 'Matías Jaramillo', 'Editorial Barranquilla', 67000);
insert into articulo values ('Desarrollo de Aplicaciones de Escritorio', 'Ana Arroyo', 'Editorial Cartagena', 85000);
insert into articulo values ('Introducción a SQL', 'Santiago Torres', 'Editorial Pacífico', 55000);
insert into articulo values ('Desarrollo de Aplicaciones Web con Django', 'Camila Gómez', 'Editorial Colombia', 72000);
insert into articulo values ('Programación en TypeScript', 'Carlos Pérez', 'Editorial Nacional', 65000);
insert into articulo values ('Desarrollo de Aplicaciones de Android', 'Valentina Hernández', 'Editorial Andina', 88000);
insert into articulo values ('Introducción a la Programación en R', 'Diego Gómez', 'Editorial Bogotá', 58000);
insert into articulo values ('Desarrollo de Aplicaciones de iOS', 'Luciano Martínez', 'Editorial Medellín', 76000);
insert into articulo values ('Programación en Kotlin', 'Mariano Ramírez', 'Editorial Bogotá', 64000);
insert into articulo values ('Desarrollo de Aplicaciones de Windows', 'Juan Pablo Herrera', 'Editorial Cúcuta', 78000);
insert into articulo values ('Programación en JavaScript', 'Andrés Vargas', 'Editorial Armenia', 59000);
insert into articulo values ('Desarrollo de Aplicaciones de Linux', 'Sara Gómez', 'Editorial Santa Marta', 70000);
...
insert into compania values ('800890891-3', 'Seguros Colombianos', 2005, 'Jorge Martínez');
insert into compania values ('900001000-4', 'Aseguradora Barranquilla', 1997, 'Sandra Gómez');
insert into compania values ('899999900-6', 'Seguros Medellín', 2000, 'Luis Carlos Gutiérrez');
insert into compania values ('899999902-7', 'Aseguradora Nacional', 1992, 'María Fernández');
insert into compania values ('899999905-1', 'Seguros del Caribe', 2008, 'Carlos Rojas');
insert into compania values ('800890893-2', 'Aseguradora Cali', 1995, 'Lucía Suárez');
insert into compania values ('800890894-8', 'Seguros Bogotá', 1990, 'Juan Pérez');
insert into compania values ('900001005-2', 'Aseguradora Occidente', 2006, 'Laura Herrera');
insert into compania values ('899999910-5', 'Seguros Pacifico', 2003, 'Luisa Martínez');
insert into compania values ('899999915-9', 'Aseguradora Andina', 1998, 'Diego Soto');
insert into compania values ('800890900-7', 'Seguros Cartagena', 1996, 'Valentina Hernández');
insert into compania values ('800890903-1', 'Aseguradora Cúcuta', 2007, 'Miguel Ángel López');
insert into compania values ('900001010-7', 'Seguros Pereira', 2004, 'Camila Gómez');
insert into compania values ('800890910-5', 'Aseguradora Cali', 2001, 'Andrés Vargas');
insert into compania values ('899999920-2', 'Seguros Medellín', 1994, 'Sofía Torres');
insert into compania values ('900001015-1', 'Aseguradora Santander', 1999, 'Julián Ramírez');
insert into compania values ('899999925-0', 'Seguros Barranquilla', 2002, 'Valentín Soto');
insert into compania values ('899999930-4', 'Aseguradora Bogotá', 1993, 'Lucía Martínez');
insert into compania values ('800890920-4', 'Seguros Armenia', 2006, 'Esteban Suárez');
insert into compania values ('899999935-3', 'Aseguradora Valle', 1995, 'Natalia Gutiérrez');
insert into compania values ('800890925-9', 'Seguros Cauca', 2003, 'Simón López');
insert into compania values ('899999940-7', 'Aseguradora Antioquia', 1998, 'Ana María Torres');
insert into compania values ('899999945-1', 'Seguros Bolívar', 2005, 'Andrés Pérez');
insert into compania values ('899999950-1', 'Aseguradora Caldas', 2002, 'Valentina Ramírez');
insert into compania values ('800890930-0', 'Seguros Caquetá', 1991, 'Luis Torres');
insert into compania values ('800890935-4', 'Aseguradora Huila', 2007, 'María Rodríguez');
insert into compania values ('899999955-8', 'Seguros Casanare', 1992, 'Juan Gómez');
insert into compania values ('800890940-2', 'Aseguradora Meta', 2004, 'Santiago Martínez');
insert into compania values ('900001020-4', 'Seguros Guaviare', 1999, 'Valeria Gómez');
insert into compania values ('800890945-9', 'Aseguradora Putumayo', 1994, 'Camilo López');
insert into compania values ('899999960-7', 'Seguros Chocó', 2008, 'María Fernández');
insert into compania values ('800890950-5', 'Aseguradora Nariño', 2006, 'Carlos Gómez');
insert into compania values ('899999965-1', 'Seguros Risaralda', 1990, 'Mariana López');
insert into compania values ('899999970-1', 'Aseguradora Quindío', 1995, 'Miguel Ángel Ramírez');
insert into compania values ('899999975-6', 'Seguros Guainía', 2001, 'Lucía Martínez');
insert into compania values ('900001025-9', 'Aseguradora Vaupés', 1996, 'Diego Pérez');
insert into compania values ('800890955-0', 'Seguros Amazonas', 1993, 'Sofía Gómez');
insert into compania values ('800890960-0', 'Aseguradora San Andrés', 2007, 'Andrés Ramírez');
insert into compania values ('899999980-4', 'Seguros Providencia', 2003, 'Natalia López');
insert into compania values ('899999985-8', 'Aseguradora Arauca', 2009, 'Simón Gómez');
insert into compania values ('899999990-5', 'Seguros Vichada', 1991, 'Ana María Ramírez');
insert into compania values ('900001030-0', 'Aseguradora Cesar', 1997, 'Andrés Torres');
insert into compania values ('800890965-5', 'Seguros Magdalena', 2004, 'Valentina Gutiérrez');
insert into compania values ('800890970-5', 'Aseguradora Sucre', 1994, 'Juan Fernando López');
insert into compania values ('900001035-5', 'Seguros La Guajira', 2002, 'Mariana Pérez');
insert into compania values ('899999995-1', 'Aseguradora Caquetá', 1998, 'Diego Torres');
...
insert into tiposAutomotores values (19, 'Grúas');
...
insert into tiposAutomotores values (23, 'Helicópteros');
...
insert into tiposAutomotores values (28, 'Ciclo Montaña');
...
insert into incidentes values ('2023-11-01', 'Bogotá', 2, 1, 3, 'HJL730');
insert into incidentes values ('2023-11-02', 'Medellín', 1, 0, 2, 'MNO890');
...
insert into incidentes values ('2023-11-09', 'Cúcuta', 0, 0, 0, 'UVW012');
insert into incidentes values ('2023-11-10', 'Manizales', 0, 0, 1, 'XYZ345');
insert into incidentes values ('2023-11-11', 'Ibagué', 1, 0, 2, 'BCD678');
...
insert into incidentes values ('2023-11-15', 'Popayán', 0, 0, 0, 'MOP890');
...
insert into incidentes values ('2023-11-19', 'Quibdó', 1, 0, 2, 'OPQ062');
...
insert into incidentes values ('2023-11-22', 'Puerto Carreño', 0, 0, 0, 'GHI901');
...
insert into incidentes values ('2023-11-26', 'San Andrés', 1, 0, 2, 'YBC123');
...
insert into incidentes values ('2023-11-30', 'Ciénaga', 0, 0, 1, 'JJL345');
...
insert into incidentes values ('2023-12-07', 'Cúcuta', 0, 0, 1, 'LM2456');
...
insert into incidentes values ('2023-12-10', 'San Andrés', 2, 1, 3, 'JKL145');
...
insert into incidentes values ('2023-12-16', 'Ciénaga', 1, 0, 2, 'YBS123');
...
/* i. Visualizar los clientes que cumplen años según un mes ingresado por 
parámetros. */
